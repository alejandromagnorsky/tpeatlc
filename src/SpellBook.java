...
public class SpellBook {
	...
	public List<Element> getDerivedElements(Element e, HashMap<Potion, Element> magic){
	...
	public List<Element> getTerminalElements(List<Element> elements, HashMap<Potion, Element> magic){
	...
	public List<Element> getBasicIngredientsFromElement(Element e, HashMap<Potion, Element> magic){
		...
		while (it.hasNext()){
			...
			if (pair.getValue().equals(e)){
				...
				if (!magic.containsValue(p.get(0)) && !required.contains(p.get(0)))
					required.add(p.get(0));
				if (!magic.containsValue(p.get(1)) && !required.contains(p.get(1)))
	...
	public List<Element> getBasicElements(List<Element> elements, HashMap<Potion, Element> magic){
